...
export const getRandomColorPairs = (count) => {
  ...
  for (let i = 0; i < count; i++) {
    // randoeColor function is provided by https://github.com/davidmerfield/randomColor
...
export function setTimerText(text) {
  const timeerElement = getTimerElement()
  if (timeerElement) timeerElement.textContent = text
}
